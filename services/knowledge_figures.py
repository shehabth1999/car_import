...
def fees_document():
    ...
    lines += ['## تكلفة الرخصة نفسها',
              ...
              'الأرقام دي مصاريف منفصلة. السعر الكامل لعربية معيّنة (الإجمالي ومقدم التعاقد والباقي) '
...
المبادرة بتسمح بعربية مستعملة بحد أقصى ثلاث سنوات، أو زيرو موديل السنة — الاتنين مسموحين. أقدم من
ثلاث سنوات مرفوض. التسجيل في المبادرة مقفول من 2024: اللي معاه مبادرة قديمة يقدر يستخدمها، واللي
مش معاه مبادرة الشركة بتوفّرهاله.

## المبادرة من خارج الاتحاد الأوروبي وشهادة يورو 1
مبادرة السعودية والخليج وأي مبادرة من خارج الاتحاد الأوروبي لا تسمح بتقديم شهادة يورو 1.
